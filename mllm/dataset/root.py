...
__all__ = [
    'IMAGE_PLACEHOLDER', 'BOXES_PLACEHOLDER', 'EXPR_PLACEHOLDER', 'OBJS_PLACEHOLDER', 'QUESTION_PLACEHOLDER', 'POINTS_PLACEHOLDER', 'NUM_OBJS_PLACEHOLDER',
    'FUNCTIONS',
    'DATASETS',
    'TRANSFORMS',
    'METRICS',
